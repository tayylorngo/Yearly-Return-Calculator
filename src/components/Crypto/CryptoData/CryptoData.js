            ...
            return(
                <div>
                    <div className="stockNameAndPrice">
                        ...
                        <h2 id="currentPrice">Current Price: {this.priceifyNoColor(this.props.currentPrice.toFixed(2))}</h2>
                    </div>
                    <Container className="yearlyDataContainer">
                        ...
                        <Row>
                            <Col>
                                <h2 id="numOfShares">Amount: {this.state.shares}</h2>
                                <Form
                            ...
                            <Col className="profitCard" >
                                <Card style={{ width: '18rem' }}>
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            {this.priceifyNoColor(this.props.yearLow)} per share
                                            <br/>
                        ...
                        <Row>
                            <Col>
                                <Table striped bordered variant="light" className="dataTable">
                                    ...
                                    <tr>
                                        <th>
                                            {this.priceifyNoColor(this.props.volume).slice(1)}
                                        </th>
                                        <th>
                                            {this.priceifyNoColor(this.props.averageVolume).slice(1)}
                                        </th>
                                    </tr>
                                    </tbody>
                                </Table>
